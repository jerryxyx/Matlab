function [ ] = Table_IV_Daily_Monitored_OutOptions_FengLinetsky( )

% Table IV The prices of vanilla options and one-year daily-monitored barrier op-
% tions in various L´ evy models
% To compare with  Feng and Linetsky (2008)
...
params = [ 0.3 ];
params = [ 0.2 ]; %%% The Taible IV the same as Feng & Linetsky (2008)’s Table 7.1
...
rho = 0.00;
% params = [ 0.0001,  12, 0.5, 5, 5 ];  %% Table 2 parameters  the parameters in Banking Finance 2013
...
%model = modelNIG;  %% This model is not used 
...
VanillaCallOption =     CosineMethodCallPricingFFT( 5000, 10 , model, S, K, T, r, d);  
