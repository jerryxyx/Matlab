...
S_vector = K*(0.75:0.003:1.25);


% S_vector = 81*(0.8:0.001:1.2);
...
VanillaPutOption(  i_S_vector  )  = VanillaCallOption + K * exp(-r*T) - S*exp(-d*T);
...
format long
% plot(  S_vector,  VanillaPutOption  ) 
...
title('Prices of a double-barrier put optio with different monitoring frequencies')
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
